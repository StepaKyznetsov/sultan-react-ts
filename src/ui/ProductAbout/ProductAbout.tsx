...
const ProductAbout: React.FC<IProductAbout> = ({
  ...
  return (
    <div className={css.about} data-testid="product-page">
      <span className={css.stock}>В наличии</span>
      ...
      <div className={css.interaction}>
        ...
        <div onClick={() => addToCart()}>
          <button className={css.priceButton}>
            В корзину
            <img src="/images/catalog/basket.png" alt="download" />
          </button>
        </div>
      </div>
      <div className={css.more}>
        <div className={css.share}>
          <img src="/images/product/share.png" alt="share" />
        </div>
        <div className={css.promotion}>
          При покупке от 10 000 ₸ бесплатная
          <br />
          доставка по Кокчетаву и области
        </div>
        <button className={css.priceList}>
          Прайс-лист
          <img src="/images/product/download.png" alt="download" />
        </button>
      </div>
    </div>
  );
