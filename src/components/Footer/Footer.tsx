  ...
  return (
    <footer className={css.container}>
      <div className={css.content}>
        ...
        <div className={css.column}>
          <span className={css.head}>Меню сайта:</span>
          {LINKS[0].map((e: string) => (
            <span className={css.link} key={e}>
              {e}
            </span>
          ))}
        </div>
        <div className={css.column}>
          <span className={css.head}>Категории:</span>
        ...
        <div className={css.column}>
          ...
          />
          <span className={css.connect}>Связь в мессенджерах:</span>
          <div>
            <img
              ...
              alt="whatsup"
            />
            <img src="/images/footer/tg.png" alt="telegram" />
          </div>
        </div>
        <div className={css.column}>
          <span className={css.head}>Контакты:</span>
          <span className={css.number}>+7 (777) 490-00-91</span>
          <span className={css.time}>время работы: 9:00-20:00</span>
          <span className={css.call}>Заказать звонок</span>
