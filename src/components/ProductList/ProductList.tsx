...
const ProductList: React.FC<IProductList> = ({
  ...
  useEffect(() => {
    ...
    filterState.open ? (footer.display = "none") : (footer.display = "block");
    ...
    <div className={css.main}>
      <div className={css.filters}>
        <div className={css.params}>
          ...
          >
            <div>
              <span className={css.price}>Цена</span>
        ...
        <div className={css.brand}>
          <BrandsFilter
            ...
            setRequestData={setRequestData}
          />
          <SideBarFilters filterState={filterState} />
        </div>
      </div>
      {!resultArray.length ? (
        <h2 className={css.emptyList}>Подходящих товаров не нашлось</h2>
      ) : (
        <div
          className={
            filterState.open
