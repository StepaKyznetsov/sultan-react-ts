    ...
    <>
      <header className={css.container} ref={wrapperRef}>
        ...
        >
          ...
          <nav>
            {LINKS[0].map((e) => (
              <span role="link" key={e} className={css.link}>
                {e}
              </span>
            ))}
          </nav>
          <button className={css.priceBtn}>
            Прайс-лист
            <img src="/images/menu/download.png" alt="download" />
          </button>
        </div>
        <div className={css.mobile} data-testid="mobile">
          <div className={css.head}>
            ...
            <img className={css.logo} src="/images/menu/logo.png" alt="logo" />
            <Basket />
          </div>
          <div className={css.btns}>
            <div onClick={() => navigate(CATALOG)} className={css.catalog}>
              <img src="/images/header/catalog.png" alt="catalog" />
              <span>Каталог</span>
            </div>
            <div className={css.catalog}>
              <img src="/images/header/find.png" alt="catalog" />
              <span>Поиск</span>
            </div>
          </div>
        </div>
